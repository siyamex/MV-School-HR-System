    ...
    <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" 
                               ...
                               name="name" 
                               required
                               value="<?php echo htmlspecialchars($_POST['name'] ?? $department['name']); ?>"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                  placeholder="Enter department description"><?php echo htmlspecialchars($_POST['description'] ?? $department['description']); ?></textarea>
                    </div>
                        ...
                        <select id="head_id" 
                            ...
                            <?php foreach ($potentialHeads as $head): ?>
                                <option value="<?php echo $head['id']; ?>" 
                                        <?php echo (($_POST['head_id'] ?? $department['head_id']) == $head['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   name="is_active" 
                                   value="1" 
                                   <?php echo (($_POST['is_active'] ?? $department['is_active']) == '1') ? 'checked' : ''; ?>
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="text-sm text-gray-900 dark:text-white"><?php echo $department['id']; ?></p>
                    </div>
                    <div>
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Created:</span>
                        <p class="text-sm text-gray-900 dark:text-white">
                            <?php echo date('M j, Y g:i A', strtotime($department['created_at'])); ?>
                        </p>
                    </div>
                    <div>
                        <span class="text-sm font-medium text-gray-500 dark:text-gray-400">Last Updated:</span>
                        <p class="text-sm text-gray-900 dark:text-white">
                            <?php echo date('M j, Y g:i A', strtotime($department['updated_at'])); ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-3">
                    <a href="<?php echo APP_URL; ?>/departments/view/<?php echo $department['id']; ?>"
                       class="block w-full text-center px-4 py-2 text-sm font-medium text-blue-600 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
                        <i class="fas fa-eye mr-2"></i>
                        View Department Details
                    </a>
                    <a href="<?php echo APP_URL; ?>/employees?department=<?php echo $department['id']; ?>"
                       class="block w-full text-center px-4 py-2 text-sm font-medium text-green-600 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
