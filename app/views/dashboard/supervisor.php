        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-3 text-lg text-gray-600 dark:text-gray-400">
                    Manage your department and oversee team activities.
                </p>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <div class="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-1">
                        <?php echo number_format($stats['department_staff']); ?>
                    </div>
                    <div class="text-sm font-medium text-blue-700 dark:text-blue-300">Department Staff</div>
                    <div class="text-xs text-blue-600 dark:text-blue-400 mt-1">Active members</div>
                </div>
        ...
        <div class="relative overflow-hidden bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 rounded-2xl p-6 border border-emerald-200 dark:border-emerald-800/50 hover:shadow-lg transition-all duration-300">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <div class="text-xs text-emerald-600 dark:text-emerald-400 mt-1">Department staff</div>
                </div>
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Department Leave Requests</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Pending approvals from your team</p>
                            </div>
                        </div>
                ...
                <div class="p-6">
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <p class="text-gray-500 dark:text-gray-400">No pending leave requests from your department</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Supervisor information</p>
                        </div>
                    </div>
                </div>
                <div class="p-6">
                    <div class="text-center">
                        <div class="w-20 h-20 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white text-xl font-semibold mx-auto mb-4">
                            <?php echo strtoupper(substr($employee['first_name'] ?? 'N', 0, 1) . substr($employee['last_name'] ?? 'A', 0, 1)); ?>
                        </div>
                        <h4 class="text-lg font-semibold text-gray-900 dark:text-white">
                            <?php echo htmlspecialchars(($employee['first_name'] ?? '') . ' ' . ($employee['last_name'] ?? '')); ?>
                        </h4>
                        <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo htmlspecialchars($employee['position'] ?? 'Supervisor'); ?></p>
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1"><?php echo htmlspecialchars($employee['employee_id'] ?? 'N/A'); ?></p>
                        
                        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <a href="<?php echo APP_URL; ?>/profile" class="inline-flex items-center px-3 py-2 text-sm font-medium text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-3">
                        <a href="<?php echo APP_URL; ?>/leaves" class="flex items-center p-3 rounded-xl bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/10 dark:to-amber-800/10 border border-amber-200 dark:border-amber-800/30 hover:from-amber-100 hover:to-amber-200 dark:hover:from-amber-900/20 dark:hover:to-amber-800/20 transition-all duration-200 group">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-gray-900 dark:text-white">Approve Leaves</p>
                        ...
                        <a href="<?php echo APP_URL; ?>/attendance" class="flex items-center p-3 rounded-xl bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-900/10 dark:to-emerald-800/10 border border-emerald-200 dark:border-emerald-800/30 hover:from-emerald-100 hover:to-emerald-200 dark:hover:from-emerald-900/20 dark:hover:to-emerald-800/20 transition-all duration-200 group">
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-gray-900 dark:text-white">Attendance</p>
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Department Overtime</h3>
            ...
            <div class="p-6">
                ...
                <?php else: ?>
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-500 dark:text-gray-400">No pending overtime requests from your department</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Department Summary</h3>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="text-center p-4 bg-blue-50 dark:bg-blue-900/10 rounded-xl">
                            ...
                            <div class="text-xs text-blue-600 dark:text-blue-400">Team Members</div>
                        </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between p-3 bg-amber-50 dark:bg-amber-900/10 rounded-lg">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm font-medium text-gray-900 dark:text-white">Leave Approvals</span>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-orange-50 dark:bg-orange-900/10 rounded-lg">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm font-medium text-gray-900 dark:text-white">Overtime Approvals</span>
                            </div>
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <a href="<?php echo APP_URL; ?>/employees" class="block w-full text-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 rounded-2xl border border-blue-200 dark:border-blue-800/30 p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h4 class="text-lg font-semibold text-gray-900 dark:text-white">Department Supervision</h4>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Managing team operations and approvals</p>
                </div>
            </div>
            <div class="text-right">
                <p class="text-sm text-gray-500 dark:text-gray-400">Supervisor Panel</p>
                <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Department oversight access</p>
            </div>
        </div>
    </div>
</div>
